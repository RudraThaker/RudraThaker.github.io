...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Machine Learning.", "Software Developer.", "Deep Learning."],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "13 Cornelia ct, Boston, Massachusetts",  /* You can change your address from here */
            html: "<b>Address</b>: <br> Boston Massachusetts",   /* You can change display address text from here */
            popup: true
            }
            ]
            });
